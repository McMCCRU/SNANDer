...
//AMIC --> http://amictechnology.com/english/flash_spi_flash.html
...
//EXCELSEMI
	{ "ES25P10", 		0x4a, 0x20110000, 64 * 1024, 2,    0, 2.70, 3.60 },
	{ "ES25P20", 		0x4a, 0x20120000, 64 * 1024, 4,    0, 2.70, 3.60 },
	{ "ES25P40", 		0x4a, 0x20130000, 64 * 1024, 8,    0, 2.70, 3.60 },
	{ "ES25P80", 		0x4a, 0x20140000, 64 * 1024, 16,   0, 2.70, 3.60 },
	{ "ES25P16", 		0x4a, 0x20150000, 64 * 1024, 32,   0, 2.70, 3.60 },
    	{ "ES25P32", 		0x4a, 0x20160000, 64 * 1024, 64,   0, 2.70, 3.60 },
    	{ "ES25M40A", 		0x4a, 0x32130000, 64 * 1024, 8,    0, 2.70, 3.60 },
	{ "ES25M80A", 		0x4a, 0x32140000, 64 * 1024, 16,   0, 2.70, 3.60 },
        { "ES25M16A", 		0x4a, 0x32150000, 64 * 1024, 32,   0, 2.70, 3.60 },
...
// --> https://www.winbond.com/hq/product/code-storage-flash-memory/serial-nor-flash/?locale=en&selected=32Mb#Density
	...
	{ "W25Q40", 		0xef, 0x40130000, 64 * 1024, 8,    0, 2.70, 3.60 },
...
//Boya Microelectronics --> http://www.boyamicro.com/SPI_Nor_Flash.php
	{ "BY25D40AS",		0x68, 0x40130000, 64 * 1024, 8,    0, 2.70, 3.60 },
	{ "BY25Q40BL",		0x68, 0x10130000, 64 * 1024, 8,    0, 1.65, 2.10 },
	{ "BY25Q40BL",		0x68, 0x60130000, 64 * 1024, 8,    0, 1.65, 2.00 },
	...
	{ "BY25Q64AL",		0x68, 0x60170000, 64 * 1024, 128,  0, 1.65, 1.95 },
	{ "BY25Q128AS",		0x68, 0x40180000, 64 * 1024, 256,  0, 2.70, 3.60 },
	{ "BY25Q128EL",		0x68, 0x60180000, 64 * 1024, 256,  0, 1.65, 1.95 },
...
//ISSI --> https://www.issi.com/US/product-flash.shtml
	...
	{ "IS25LP256D",		0x9d, 0x601A0000, 64 * 1024, 1024, 1, 2.30, 3.60 },
	{ "IS25WP256D",		0x9d, 0x701A0000, 64 * 1024, 1024, 1, 1.65, 1.95 },
